---
layout:     post
title:      "提高mysql千万级大数据SQL查询优化30条经验（Mysql索引优化注意）「转」"
subtitle:   "Improve the mysql being big data SQL query optimization article 30 experience (mysql index optimization note)   "
date:       2014-7-7
author:     "LingDie | 靈蝶"
header-img: "img/blog/2014/msq.jpg"
tags:
    - Mysql
    - 优化
    - 转载
